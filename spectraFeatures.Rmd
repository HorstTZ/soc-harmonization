...
-----------------------------------------------------------
```{r}
limRef <- data.frame(mineral = numeric(), lower = numeric(), upper = numeric())

ref[1,] <- c("Kaolinite", 2078, 2267)
ref[2,] <- c("Goethite1", 457, 563)
ref[3,] <- c("Goethite2", 776, 1266)
ref[4,] <- c("Hematite1", 455, 612)
ref[5,] <- c("Hematite2", 765, 1050)
```
...
#data("mineralRef")  #reference spectra 
str(mineralRef)
...
#write.csv(index, "../data/dataFinal.csv")
```
