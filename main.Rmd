...
```{r}
data <- read.csv("../data/dataFinal.csv", sep = ",")
...
p5 <- barchart(
  data$geology, xlab = 'Parental material', ylab = 'Percent of total', horizontal = FALSE, 
  col = 'lightgray',
  panel = function (...) {
...
TWI
```{r}
TWI <- raster::raster("../data/raster/twi/sTWI.tif")
```
...
MAPBIOMAS
```{r}
lulc2009 <- raster::raster("../data/raster/lulc/lulc2009_wgs84.tif")
lulc2013 <- raster::raster("../data/raster/lulc/lulc2013_wgs84.tif")
lulc2016 <- raster::raster("../data/raster/lulc/lulc2016_wgs84.tif")
```
...
### Soil particle size classes (clay, silt and sand)
The soil particle size classes (clay, silt and sand) were transformed from % to g.kg (*10)
`texture`
