...
p1 <- histogram(
  ~ rKao, data, 
  xlab = expression('Relative abundance of Kaolinite'), col = 'lightgray', type = "percent", 
  panel = function (...) {
    panel.grid(v = -1, h = -1)
    panel.histogram(...)
    lattice::panel.rug(...)
...
p2 <- histogram(
  ~ rGoe, data, 
  xlab = expression('Relative abundance of Goethite'), col = 'lightgray', type = "percent", 
  panel = function (...) {
    panel.grid(v = -1, h = -1)
    panel.histogram(...)
    lattice::panel.rug(...)
...
p3 <- histogram(
  ~ rHem, data, 
  xlab = expression('Relative abundance of '), col = 'lightgray', type = "percent", 
  panel = function (...) {
    panel.grid(v = -1, h = -1)
    panel.histogram(...)
    lattice::panel.rug(...)
...
formulas <- lapply(1:nrow(soc_methods), function (i) {
  ...
  list(
    ...
    glue("{y} ~ 1 + {x} + I({x}^2) + {specOrg} + {specOH} + {x}*clay + {specMinAbund}"), #F
    
    glue("{y} ~ 1 + {x} + I({x}^2) + {specOrg} + {specMinAbund} + {specOH} + {x}*clay"), #G
    glue("{y} ~ 1 + {x} + I({x}^2) + {specOrg} + {specMinAbund} + {specOH} + {x}*clay + I({x}^2)*clay + {texture} + {landuse} + {coordinates}"), #H
    glue("{y} ~ 1 + {x} + I({x}^2) + {x}*clay + I({x}^2)*clay + {texture} + {landuse} + {coordinates}") #H
)
})
